...
Kyle Roth is a third-year PhD candidate in the Département d'informatique et de recherche opérationelle (DIRO) at the Université de Montréal. He is advised by \href{https://www-labs.iro.umontreal.ca/~liubang/cv.pdf}{Bang Liu}. His research focuses on the structured use of LLMs within larger pipelines and agent systems, both from robustness and sociotechnical perspectives. His main research project focuses on augmenting these systems with structures for procedural knowledge understanding and adaptation for planning.

\cvsection{EDUCATION}

{\cventry{Doctor of Philosophy (Ph.D.)}{Sep 2021 -}{DIRO, Université de Montréal \& Mila}{Montréal, Canada}{
    \begin{itemize}
...
{\cvproject{Mitacs Accelerate}{Aug 2022 - May 2024}{30,000 CAD. Principal research intern.}{
    \begin{itemize}
      ...
      \item \textit{Project description:} We sought to build an LLM-enabled system to handle procedural knowledge (how-to instructions). Retrieval-augmented generation (RAG) is widely used to improve the factuality of LLMs' outputs, but can struggle to collect information from the wide set of documents and combine them coherently to produce novel procedures. To address this we developed a method called analogy-augmented generation (AAG) to address this, and tested it on datasets in several procedural knowledge domains, including a dataset of LangChain tutorials we constructed.
    \end{itemize}
  }
}
...
{\cvpub{\textbf{K Roth}, Rushil Gupta, Simon Halle, Bang Liu}{Pairing Analogy-Augmented Generation with Procedural Memory for Procedural Q\&A}{Under review at ACL ARR.}{}{https://arxiv.org/abs/2409.01344}}
...
{\cvproject{teaching assistant}{Jan - May (2023, 2024)}{Université de Montréal; IFT 6759: advanced machine learning projects}{
    \begin{itemize}
      \item Advised student groups weekly to help design their experiments
      \item Taught introductory lectures on Linux, Git, SLURM, and other development tooling
    \end{itemize}
  }
}
...
\begin{itemize}
  ...
  \item 2024 - KDD, TOMM, NeurIPS, CIKM, COLM, ECCV, IJCAI, TNNLS, SIGIR, NAACL, SoLaR
  \item 2023 - Coling, TNNLS, ICKG, AAAI, CVPR, WSDM, CIKM, WWW, ACL ARR, Elsevier Pattern Recognition
...
\begin{itemize}
  ...
  \item \textbf{tools:} PyTorch, LangChain, Weaviate, SLURM, Git, Docker, Flutter, scikit-learn, TensorFlow, AWS, SQL
        ...
        \textcolor{white}{keywords: LLMs, NumPy, SciPy, Bash, Pandas, PySpark, Linux, Android}
\end{itemize}
