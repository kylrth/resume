...
{\cventry{Université de Montréal}{Montréal, QC}{Ph.D., Computer Science; advised by Dr.~Bang Liu}{Sep 2021 - May 2026}{
    \begin{itemize}
      \item Research on augmenting large language models to better interact with procedural knowledge (code library documentation and instruction manuals)
      \item \textbf{3.7 GPA}; accelerated admission in fall 2022 from M.Sc.~(\textbf{4.3 GPA})
      \item Taught Linux and Git lectures for advanced machine learning projects class
    \end{itemize}
  }
}
...
{\cventry{Brigham Young University}{Provo, UT}{B.S., Mathematics; Applied and Computational Mathematics Emphasis}{Aug 2014 - Dec 2019}{
    \begin{itemize}
      ...
      \item \textbf{Senior project}: scored 76\% accuracy on phoneme classification of the TIMIT corpus (final report \href{https://github.com/jarednielsen/speech2phone/blob/master/results/winter_semester_report.pdf}{here})
