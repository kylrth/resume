...
{\cventry{Ph.D., Computer Science}{Sep 2021 -}{DIRO, Université de Montréal \& Mila}{Montréal, Canada}{
    \begin{itemize}
      \item \textbf{GPA 4.0}/4.3; accelerated admission in fall 2022 from M.Sc.~(\textbf{GPA 4.3}/4.3)
    \end{itemize}
  }
}

{\cventry{B.S., Applied Mathematics}{Aug 2014 - Dec 2019}{Department of Mathematics, Brigham Young University}{Provo, USA}{
    \begin{itemize}
      \item Applied and Computational Mathematics Emphasis (\href{https://acme.byu.edu}{ACME})
      \item \textbf{GPA 3.9}/4.0 (Cum Laude); minor in computer science; concentration in linguistics
    \end{itemize}
  }
}
...
{\cvpub{\textbf{K Roth}*, Rushil Gupta*, Simon Halle, Bang Liu}{Analogy-Augmented Generation with Procedural Memory for Procedure Generation}{Accepted for oral presentation at PAKDD 2025.}{}{https://arxiv.org/abs/2409.01344}}
...
{\cvproject{teaching assistant}{Jan - May (2023, 2024, 2025)}{Université de Montréal; IFT 6759: advanced machine learning projects}{
    \begin{itemize}
      \item Advised student groups weekly to help design their experiments
      \item Taught introductory lectures on Linux, Git, SLURM, and ML research tooling
    \end{itemize}
  }
}
